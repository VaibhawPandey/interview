package com.competitiveCodes.string;
 ...
 * @author Tushar Roy
 *
 * DesignPattern an algorithm to encode a list of strings to a string. The encoded string is then sent over the network
