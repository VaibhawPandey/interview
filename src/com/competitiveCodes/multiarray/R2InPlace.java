package com.competitiveCodes.multiarray;
...
public class R2InPlace {
	public static void main(String[] args) {
      ...
      //   rotate(a1, 3); //should return:
        ...
        System.out.println(Arrays.deepToString(a2).replace("], ", "]\n").replace("[[", "[").replace("]]", "]"));
    ...
    public static int[][] rotate(int[][] a, int n) {
        ...
        for (int i = 0; i < n / 2 + n % 2; i++) {
            for (int j = 0; j < n / 2; j++) {
                ...
                System.out.println("k[] array= " + Arrays.toString(tmp) +  " after i= " + i  + ", j= " + j);
                ...
                System.out.println("after i= " + i  + ", j= " + j + " current_i= " + currentI + ", currentJ= " + currentJ + " original a[] :");
